...
class Ui_model_selection(object):
    def setupUi(self, model_selection):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 793, 598))
        ...
        self.label_3.setMaximumSize(QSize(121, 16777215))
    ...
    def retranslateUi(self, model_selection):
        ...
        self.label_2.setText(QCoreApplication.translate("model_selection", u"Time column:", None))
        self.time_col.setText(QCoreApplication.translate("model_selection", u"0", None))
        self.label_3.setText(QCoreApplication.translate("model_selection", u"Inputs columns:", None))
        self.label_4.setText(QCoreApplication.translate("model_selection", u"Outputs columns:", None))
