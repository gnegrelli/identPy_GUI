...
class Ui_ts_setting(object):
    def setupUi(self, ts_setting):
        ...
        sizePolicy2.setHeightForWidth(self.max_iteration.sizePolicy().hasHeightForWidth())
        self.max_iteration.setSizePolicy(sizePolicy2)
        ...
        self.estimate = QPushButton(ts_setting)
    ...
    def retranslateUi(self, ts_setting):
        ...
        self.estimate.setText(QCoreApplication.translate("ts_setting", u"Estimate", None))
    # retranslateUi
